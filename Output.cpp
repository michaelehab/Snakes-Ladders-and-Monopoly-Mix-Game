...
void Output::DrawSnake(const CellPosition & fromCell, const CellPosition & toCell) const
{
	...
	int xPolygon[] = { x12,x12 + xChange,x12 + x12 +2* xChange };
	int yPolygon[] = { y1,y1 + yChange,y1 + 2 * yChange };
